...
/* eslint no-console: 0 */
var pluginName = exports.pluginName = 'aem-clientlib-webpack-plugin';
var debug = (0, _debug2.default)(pluginName);
...
class BaseLogger {
  ...
  static getLogBanner(type) {
    return BaseLogger.getColor(type)(`[${(0, _moment2.default)().format('HH:mm:ss')}] [${pluginName}]`);
  }
